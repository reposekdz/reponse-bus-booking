...
const CompanyLayout: React.FC<CompanyLayoutProps> = ({ onLogout, theme, setTheme }) => {
    ...
    const renderContent = () => {
        switch (currentPage) {
            case 'buses': return <CompanyBuses />;
            case 'drivers': return <CompanyDrivers />;
            case 'routes': return <CompanyRoutes />;
