    ...
    <section className="py-16 sm:py-24 bg-gradient-to-b from-yellow-50/30 to-white">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
            <h2 className="text-3xl font-extrabold text-gray-900 tracking-tight sm:text-4xl">Booking in 3 Easy Steps</h2>
            <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-600">Your next journey is just a few clicks away.</p>
        </div>
